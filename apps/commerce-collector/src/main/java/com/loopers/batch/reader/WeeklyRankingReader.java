...
public class WeeklyRankingReader {
    ...
    @Bean
    @StepScope
    public RepositoryItemReader<WeeklyRankingAggregateResult> weeklyRankingReader(
        ...
        RepositoryItemReader<WeeklyRankingAggregateResult> reader = new RepositoryItemReader<>();
