    ...
    class 재고_조회_시 {
        ...
        class 재고_단건_조회에_성공한다 {
            ...
            void whenValidProductId() {
                ...
                // act
                Stock result = productService.getStockByProductId(product.getId());
        ...
        class 재고_목록_조회에_성공한다 {
            ...
            void whenValidProductIds() {
                ...
                // act
                List<Stock> results = productService.getStocksByProductIds(productIds);
        ...
        @DisplayNameGeneration(DisplayNameGenerator.ReplaceUnderscores.class)
        @Nested
        class 조회에_실패하고_404_Not_Found_예외가_발생한다 {

            @DisplayName("주어진 productId에 해당하는 재고가 존재하지 않는다면")
            @Test
            void whenStockNotExists() {
                // act
                CoreException exception = assertThrows(CoreException.class, () -> productService.getStockByProductId(1L));
